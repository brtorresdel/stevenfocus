...
export function Timer() {
    ...
    return (
        <>
            ...
            <button className={`bg-${theme}-primary/80 hover:bg-${theme}-primary text-base-white font-body w-48 lg:w-48 md:w-70 xl:w-70 h-auto text-4xl lg:text-4xl md:text-6xl xl:text-6xl  py-2 lg:py-2 md:py-4 xl:py-4 rounded cursor-pointer`}>
                Start
            </button>
        </>
    )
